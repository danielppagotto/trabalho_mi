...
library(Rtsne); library(ggridges)
library(webr); library(RColorBrewer)
...
# extracao de dados usando codigo SQL do datalake que uso em projeto e 
# agrupando a nivel municipio
...
# Analise exploratoria da base completa antes da clusterizacao
...
# identificando o numero de clusters apropriado

data.frame(1:10, sil_width) %>%  
...
# agregado os dados de cluster a base original
